              ...
              <div className="text-center mb-8">
                <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                  ...
                  <span className="italic font-light">
                    <AnimatedText text="beauty trends." delay={0.5} />
                  </span>
                </h2>
                <p className="text-lg text-neutral-600">
                  Be the first to discover new makeup looks, beauty tips, and
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-neutral-900 mb-2">
                    Welcome to LushLooks
                  </h3>
                  <p className="text-neutral-600">
                    Thank you for subscribing. You'll receive our next
                    newsletter with exclusive insights and new arrivals.
                  </p>
                </motion.div>
              )}
