      ...
      <div className="container-custom py-20 lg:py-24">
          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <p className="text-neutral-600 mb-6 leading-relaxed">
                Professional makeup artistry for every occasion. We enhance your
                natural beauty with expert techniques, premium products, and
        ...
        >
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-neutral-500 text-center">
            <p>&copy; {currentYear} LushLooks. All rights reserved.</p>
